...
public class FoodTester {
	...
	public static void main(String[] args) {
		...
		// producer thread
		/*
		new Thread(((new CookThread(foodList)) ->
			try {
      ...
      // IMPORTANT NOTE!!! 
		...
		System.out.println("Total Cook Time = " + CookThread.totalCookTime);
		System.out.println("Total Serve Time = " + ServeThread.totalServeTime);	
